...
if((!isset($idMessage)) && (!isset($fMessage)) && (!isset($lMessage)) && (!isset($eMessage)) && (!isset($aMessage)))
{
  ...
  if((!isset($id)) && (!isset($fname)) && (!isset($lname)) && (!isset($email)) && (!isset($address)))
  {
           ...
           <div class = "col-12">
            ...
            <?php endif; ?>
              ...
              <label>Student ID:</label>
               ...
               <?php if($edit == true):?>
               <input id = "sid" type = "text" name = "student_id" value = "<?php print($id) ?>"  disabled = "disabled" > &nbsp;
               ...
               <?php else: ?>
               <input id = "sid" type = "text" name = "student_id" value = "<?php print($id)?>"> &nbsp;
               <?php endif; ?>
              ...
              <?php elseif($del == true):?>
              <input id = "fname" type = "text" name = "firstName" value = "<?php print($fname) ?>" disabled = "disabled" > &nbsp;
              <?php else:?>
              <input id = "fname" type = "text" name = "firstName" value = "<?php print($fname) ?>" > &nbsp;
              <?php endif; ?>
              ...
              <?php elseif($del == true):?>
              <input id = "lname" type = "text" name = "lastName" value = "<?php print($lname)?>" disabled = "disabled">&nbsp;
              <?php else: ?>
              ...
              <?php elseif($del ==true):?>
              <input id = "eMail" type = "email" name = "student_email" value = "<?php print($email)?>" disabled = "disabled"> &nbsp;
              <?php else:?> 
              <input id = "eMail" type = "email" name = "student_email" value = "<?php print($email)?>"> &nbsp;
              <?php endif;?>
              ...
              <?php elseif ($del == true): ?>
              <input id = "Address" class = "add" type = "text" name = "address" value = "<?php print($address)?>" disabled = "disabled">&nbsp;
              <?php else: ?>
              <input id = "Address" class = "add" type = "text" name = "address" value = "<?php print($address)?>">&nbsp;
              <?php endif; ?>
              ...
              <p id = "status"></p>
              <?php if($edit == true):?>
              <!--<button id = "add" class = "btn" type = "submit" name = "add" value = "Update"> <a style = "text-decoration: none; color:white;" href = "update.php?id=".$id >Update</a></button> &nbsp; &nbsp;-->
              ...
              <?php elseif($del == true):?>
              <button id = "add" class = "btn" type = "submit" name = "add" value = ""> <a style = "text-decoration: none; color:white;" href = "console.php" >Please confirm that you want to delete this record</a></button> <br>
